        ...
        while not game_over:
            ...
            if not paused:
                ...
                if pygame.display.get_surface() is not None:
                    ...
                    soldout_shiled_text = small_font.render(f"x{shield_item_count}", True, dark_red)
                    life_item_count_text = small_font.render(f"x{life_item_count}", True, black)
                    soldout_life_text = small_font.render(f"x{life_item_count}", True, dark_red)
                    slow_item_count_text = small_font.render(f"x{slow_item_count}", True, black)
                    soldout_slow_text = small_font.render(f"x{slow_item_count}", True, dark_red)
